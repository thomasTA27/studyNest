...
import RainSoundButton from "./RainSound";
...
export default function PomodoroWidget() {
  ...
  const handleTimerComplete = () => {
    if (mode === "work") {
      ...
      showToast(
        "Back to work!",
        "Break's over. Let's get back to being productive!"
      );
    }
  ...
  const createSession = () => {
    ...
    showToast(
      "Nest created!",
      `Your nest ID is ${newSessionId}. Invite your study buddies!`
    );
  };
  ...
  const joinSession = () => {
    ...
    showToast(
      "Joined the nest!",
      "You've successfully joined the study session!"
    );
  };
  ...
  return (
    <>
      <div className="study-nest-widget"></div>
      <div className="widget-container">
          ...
          {sessionInfo && (
            <div className="session-badge">
              <span className="participant-count">
                {sessionInfo.participants.length}
              </span>
        ...
        <div className="timer-section">
          ...
          <div className="rain-sound-container">
            <RainSoundButton />
          </div>
        </div>
